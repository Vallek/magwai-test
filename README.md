...
* Были проблемы с запросами к jsonplaceholder. На хроме, запросы висели pending. Я перетестил множество вариантов (настройки безопасности хрома, прокси, сборка js), но 100% причину проблемы пока найти не удалось. С другим api такой проблемы не было.
